...
public class DecimalUtil {
     ...
     * @return
     */
    public static String formatMoneyYuan(Long moneyFen) {
        if (moneyFen == null) {
            return "";
        }
        BigDecimal moneyFenBd = new BigDecimal(moneyFen);
        return new DecimalFormat("#0.00").format(moneyFenBd.divide(new BigDecimal(100)));
    }
     ...
     * @return
     */
    public static long formatMoneyFen(String moneyYuan) {
        if (moneyYuan == null) {
            return 0;
        }
        BigDecimal moneyFenBd = new BigDecimal(moneyYuan);
        return (moneyFenBd.multiply(new BigDecimal(100))).longValue();
    }
